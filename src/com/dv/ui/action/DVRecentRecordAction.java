/*
 * DVRecentRecordAction.java  2/6/13 1:04 PM
 *
 ...
 * @author xyma
 */
public class DVRecentRecordAction {
    ...
    public DVRecentRecordAction(DVFrame parentt, String fname, int type) {
    ...
    public void setRecentDataBaseAcess() {
        if (fname != null) {
    ...
    public void setTrackingIcon() {
        try {
            int lineNumber = Integer.parseInt(getSQLLine(dvev.getServerName()));
            if (lineNumber != -99) {
                dvev.getDvtextPane().selectRow(lineNumber);
            }
        } catch (Exception e) {
        }
    }
