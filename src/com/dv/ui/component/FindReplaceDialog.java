/*
 * FindReplaceDialog.java  6/7/13 1:49 PM
 *
...
public class FindReplaceDialog extends DefaultActionButtonsPanel
    ...
    //    public FindReplaceDialog(ActionContainer parent, int type,JTextComponent textComponent) {
    public FindReplaceDialog(JDialog parent, int type, JTextComponent textComponent) {
    ...
    private void init() throws Exception {
        ...
        JTextComponent textComponent = textComponentP;
    ...
    private void startFindReplace(Object button) {
        ...
        TextAreaSearch.setTextComponent(textComponentP);
    ...
    private boolean isValidForReplace(String find, String replacement) {
        ...
        if (replaceCheck.isSelected() && find.compareTo(replacement) == 0) {
            ...
            DataViewerUtilities.displayErrorMessage(
