/*
 * RRolloverButton.java  2/6/13 1:04 PM
 *
 ...
 */
public class RRolloverButton extends JButton
     ...
     */
    public RRolloverButton(ImageIcon img, String tip) {
        super(img);
        toolTip = tip;
        init();
    }
     ...
     * @param tip the button's tool tip
     */
    public RRolloverButton(Action a, String tip) {
        super(a);
        toolTip = tip;
        init();
    }
     ...
     * @param tip   the button's tool tip
     */
    public RRolloverButton(String label, String tip, int h, int w) {
        super(label);
        toolTip = tip;
        init();
        setButtonSize(h, w);
     ...
     * @param tip   the button's tool tip
     */
    public RRolloverButton(ImageIcon img, String tip, int h, int w) {
        super(img);
        toolTip = tip;
        init();
        setButtonSize(h, w);
     ...
     * @param tip     the button's tool tip
     */
    public RRolloverButton(String imgPath, String tip) {
        this(imgPath, tip, -1);
    }
     ...
     * @param tip     the button's tool tip
     */
    public RRolloverButton(String imgPath, String tip, int size) {
        super();
    ...
    public void setButtonIcon(String path) {
        image = new ImageIcon(RRolloverButton.class.getResource(path));
        setIcon(image);
    }
