/*
 * ExceptionErrorDialog.java  7/2/13 2:12 PM
 *
...
public class ExceptionErrorDialog extends AbstractBaseDialog
     ...
     * the exception list
     */
    private Vector<String> exceptions;
     ...
     */
    public ExceptionErrorDialog(String message, String exception, Throwable e) {
        super(DVPropMain.DV_FRAME.get("MAIN"), "Error Message", true);
...
//        }
    ...
    private void init() throws Exception {
        ...
        Point location = DataViewerUtilities.getLocationForDialog(getOwner(), size);
...
//            textPane.setBackground(getBackground());
            ...
            pasteButton = new RolloverButton(
                    new ImageIcon(ExceptionErrorDialog.class.getResource(DVFrame.getMainViewResource().getString("pasteIcon"))),
...
//            }
     ...
     */
    private void printException(String e) {
